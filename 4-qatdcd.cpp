...
int main(int argc, char** argv) {
    cout << "INFO> QATDCD version 1.0" << endl
         << "INFO> This program does NOT check sanity of trajectory files." << endl
         << "INFO> Merged trajectory will have same header as the first input except NFILE." << endl;
    if (argc<3) {
    ...
    cout << "INFO> Done. Overall number of frames: " << frame_counter << endl;
    out_file.close();
